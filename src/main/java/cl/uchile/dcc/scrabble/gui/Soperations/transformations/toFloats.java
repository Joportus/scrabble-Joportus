...
/**
 * This class represents a toFloats transformation node in our AST.
 * This means each object created by this class represents a transformation to Floats
 * operation of a treeNode object.
 */
public class toFloats extends OneChildNodes {


    /** Creates a new toFloats object.
    ...
    /**
     * Returns the Itypes result of the transformation to Floats applied to
