...
/**
 * This class represents a greater than comparison operation node in our AST.
 */
public class greaterThan extends Comparison{

    /**
     * Creates greaterThan object.
     *
    ...
    /**
     * If the variable var1 refers to is greater than the variable var2 refers to, it Returns
